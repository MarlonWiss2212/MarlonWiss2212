[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=100&size=22&letterSpacing=tight&duration=4500&pause=900&color=41B883&vCenter=true&random=true&width=435&lines=Frontend-focused+full-stack+dev.;Nuxt+%26+Vue+are+my+home+turf.;Clean%2C+accessible%2C+maintainable+UI.;From+frontend+to+infra%2C+end+to+end.;Always+learning%2C+always+shipping.;Coding+Since+'17)](https://git.io/typing-svg)

I'm **Marlon Wisskirchen**, a **frontend-focused full-stack developer** at [denkwerk](https://denkwerk.com) in Cologne. I build modern, responsive web applications with **Nuxt**, **Vue**, and **TypeScript**, caring most about clean implementation, performance, accessibility, and maintainable design systems. The work doesn't stop at the UI: I also build **NestJS** backends and own the delivery side with **AWS**, **Pulumi**, **Docker**, and **Kubernetes**. Self-taught since I was 12, I've grown from web basics into production full-stack work — and I'm always learning something new.

![Profile Views](https://komarev.com/ghpvc/?username=MarlonWiss2212&color=41B883)
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 10px;">
  ...
  <img src="https://img.shields.io/badge/-Design%20Tokens-FF6F61?style=flat&logo=css3&logoColor=white" alt="Design Tokens">
</div>
